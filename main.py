...
/* Paste this entire file immediately before the closing </style> in PANEL_HTML. */
:root{--primary:#818cf8;--primary-dim:rgba(129,140,248,.14);--bg:#0b1020;--bg2:#11182c;--bg3:#19223a;--surface:rgba(17,24,39,.92);--surface2:#121a2d;--surface3:#1a2540;--border:rgba(148,163,184,.12);--border2:rgba(129,140,248,.42);--text:#f8fafc;--text2:#cbd5e1;--text3:#94a3b8;--green:#34d399;--red:#fb7185;--yellow:#fbbf24;--header-h:100vh;--footer-h:0px}
body{background:radial-gradient(circle at 0 0,#1e1b4b 0,transparent 32%),var(--bg)}
.header{position:fixed;top:0;bottom:0;left:0;width:256px;height:100vh;padding:22px 14px;background:rgba(12,18,33,.94);border:0;border-right:1px solid var(--border);backdrop-filter:blur(22px);align-items:flex-start;z-index:101}.header-inner{height:100%;display:flex;flex-direction:column;align-items:stretch;justify-content:flex-start;gap:28px}.header-inner>div:first-child{display:flex!important;flex-direction:column!important;align-items:stretch!important;gap:14px!important}.logo{font-size:1.55rem;letter-spacing:-.04em;color:#fff;padding:4px 12px}.logo::before{content:'✦';display:inline-grid;place-items:center;width:28px;height:28px;margin-right:9px;border-radius:9px;background:linear-gradient(135deg,#818cf8,#4f46e5);font-size:.9rem;color:#fff;vertical-align:2px}.version-tag{position:absolute;top:31px;right:25px;margin:0;color:#a5b4fc;background:rgba(129,140,248,.12);border-radius:999px;padding:3px 7px}#panel-clock{margin:2px 12px 8px!important;padding:8px 10px;border:1px solid var(--border);border-radius:10px;background:rgba(255,255,255,.025);color:var(--text2)!important;font-size:.78rem!important}
.header-nav{display:flex;flex-direction:column;align-items:stretch;gap:4px;width:100%}.nav-link{display:flex;align-items:center;gap:10px;width:100%;padding:11px 12px;border-radius:10px;color:var(--text3);text-align:left;font-size:.87rem}.nav-link:hover{color:#fff;background:rgba(255,255,255,.055);border-color:transparent}.nav-link.active{color:#fff;background:linear-gradient(90deg,rgba(99,102,241,.32),rgba(99,102,241,.08));border:1px solid rgba(129,140,248,.22);box-shadow:none}
.header-right{margin-top:auto;display:grid;grid-template-columns:1fr 42px;gap:8px;align-items:center}.header-right .btn-outline{grid-column:1/-1;width:100%;justify-content:center}.header-right .lang-switch{grid-column:1/2;width:100%;justify-content:space-around;background:var(--surface3)}.header-right .btn-icon{grid-column:2;grid-row:2;padding:8px}.header-right .btn-danger{grid-column:1/-1;width:100%;justify-content:center;border-radius:10px}
.main{margin-left:256px;min-height:100vh;padding:34px 38px 48px;overflow:visible}.footer{margin-left:256px;height:44px;background:transparent;border-color:var(--border)}.page-header{margin-bottom:26px}.page-title{color:#fff;font-size:1.65rem;letter-spacing:-.035em}.page-sub{margin-top:7px;color:var(--text3)}
.stats-row{gap:16px;margin-bottom:16px}.stat-card{min-height:128px;padding:19px;border-radius:16px;background:linear-gradient(145deg,rgba(30,41,67,.92),rgba(18,26,45,.92));border-color:var(--border);box-shadow:0 10px 25px rgba(0,0,0,.12)}.stat-card:hover{transform:translateY(-3px);border-color:rgba(129,140,248,.4);box-shadow:0 16px 34px rgba(0,0,0,.2)}.stat-label{font-size:.68rem;color:var(--text3)}.stat-val{font-size:1.65rem;letter-spacing:-.04em}.stats-row:first-of-type .stat-card::before{display:block;margin-bottom:13px;font-size:1rem}.stats-row:first-of-type .stat-card:nth-child(1)::before{content:'◌';color:#818cf8}.stats-row:first-of-type .stat-card:nth-child(2)::before{content:'↗';color:#38bdf8}.stats-row:first-of-type .stat-card:nth-child(3)::before{content:'◷';color:#fbbf24}.stats-row:first-of-type .stat-card:nth-child(4)::before{content:'▣';color:#34d399}
.card{padding:20px;border-radius:16px;background:rgba(18,26,45,.88);border-color:var(--border);box-shadow:0 8px 24px rgba(0,0,0,.1)}.card-title{font-size:.92rem}.chart-container{height:240px}.btn{border-radius:9px;padding:8px 14px}.btn-primary{background:linear-gradient(135deg,#818cf8,#6366f1);color:#fff;box-shadow:0 7px 16px rgba(99,102,241,.22)}.btn-primary:hover{box-shadow:0 9px 22px rgba(99,102,241,.32)}.btn-outline{background:rgba(255,255,255,.03);border-color:var(--border)}.fi,.fs{background:rgba(15,23,42,.68);border-color:var(--border);border-radius:10px}.tbl th{background:rgba(255,255,255,.025);color:var(--text3)}.tbl td{border-color:var(--border)}.status-glass-card.active{background:rgba(52,211,153,.09);border-color:rgba(52,211,153,.22);color:var(--green)}
